...
*/
if(isset($_POST['gpa'])||isset($_POST['cgpa'])||isset($_POST['core1'])||isset($_POST['core2'])||isset($_POST['core3'])||isset($_POST['core4'])||isset($_POST['challan_no'])||isset($_POST['challan_date'])||isset($_POST['amount'])||(isset($_POST['opt1'])||isset($_POST['opt2'])||isset($_POST['opt3'])))
...
/*
	...
	*/
	...
	if(!empty($core1)||!empty($core2)||!empty($core3)||!empty($core4)||!empty($challan_no)||!empty($challan_date)||!empty($amount)||!empty($gpa)||!empty($cgpa)||!empty($total_credit))
	{
				...
				<form action="coursereg.php" method="POST">
					...
					<div id="sub">
						...
						<input type="checkbox" name="core3" value="CSE3103 " id="c3" checked> CSE3103 Periphereal And Interfacing &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3-Credits<br>
  						...
  						<input type="checkbox" name="opt1" value="CSE3102" id="o1" onclick="update(4,'o1')"> CSE3102 Database Laboratory &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.5-Credits<br>
  						<input type="checkbox" name="opt2" value=" CSE3100" id="o2" onclick="update(4,'o2')"> CSE3100 Web Programming Laboratory &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.5-Credits<br>
  						<input type="checkbox" name="opt3" value="CSE3120" id="o3" onclick="update(3,'o3')"> CSE3120 Software Engineering Labotratory &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.5-Credits<br><br><br>
