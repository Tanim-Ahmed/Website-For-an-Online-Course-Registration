...
if($x){
	/*
$query = "INSERT INTO `courses` (`code`, `cname`, `type`, `credit`) VALUES
...
if($x){
	/*
$query = "INSERT INTO `course_registered` (`username`, `core1`, `core2`, `core3`, `core4`, `opt1`, `opt2`, `opt3`, `total_credit`) VALUES
...
if($x){
	/*
$query = "INSERT INTO `students` (`username`, `fullname`, `sex`, `hostel`, `DOB`, `category`, `email`, `contact`, `sgpa`, `cgpa`, `challan_no`, `challan_date`, `amount`) VALUES
