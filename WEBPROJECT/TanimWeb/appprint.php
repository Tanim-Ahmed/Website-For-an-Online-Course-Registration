...
$query2 = "SELECT core1,core2,core3,core4,opt1,opt2,opt3,total_credit FROM course_registered WHERE username='".mysqli_real_escape_string($conn, $username)."' ";
	...
	<body>
		...
		<div class="row">
			...
			<div class="col-2">
				...
				<div id="lt">
					<br>
					<p>Name of Hall :&nbsp;</p><?php echo $hall ?><br>
